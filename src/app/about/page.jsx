...
export default function About() {
  ...
  return (
    <div>
      ...
      <div className="flex-1 bg-gray-100 p-5 border-2 h-screen font-bold mt-10 text-sm">
        ...
        <section className="mt-8">
          ...
          <ol className="list-decimal list-inside text-gray-600 text-base space-y-4">
            <li>
        ...
        <section className="mt-8">
          ...
          <ul className="list-disc list-inside text-gray-600 text-base space-y-4">
            <li>
